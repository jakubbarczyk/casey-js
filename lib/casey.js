...
const isString = exports.isString = _isString;

const isLowerCase = exports.isLowerCase = _isLowerCase;
const isUpperCase = exports.isUpperCase = _isUpperCase;
const isCamelCase = exports.isCamelCase = _isCamelCase;
const isPascalCase = exports.isPascalCase = _isPascalCase;
const isKebabCase = exports.isKebabCase = _isKebabCase;
const isSnakeCase = exports.isSnakeCase = _isSnakeCase;
const isTrainCase = exports.isTrainCase = _isTrainCase;

const caseOf = exports.caseOf = _caseOf;

const toLowerCase = exports.toLowerCase = _toLowerCase;
const toUpperCase = exports.toUpperCase = _toUpperCase;
const toCamelCase = exports.toCamelCase = _toCamelCase;
const toPascalCase = exports.toPascalCase = _toPascalCase;
const toKebabCase = exports.toKebabCase = _toKebabCase;
const toSnakeCase = exports.toSnakeCase = _toSnakeCase;
const toTrainCase = exports.toTrainCase = _toTrainCase;
