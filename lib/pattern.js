...
const KEBAB_CASE = exports.KEBAB_CASE = /^[a-z]{1}[a-z0-9]+(-[a-z0-9]+)+$/;
const SNAKE_CASE = exports.SNAKE_CASE = /^[a-z]{1}[a-z0-9]+(_[a-z0-9]+)+$/;
const TRAIN_CASE = exports.TRAIN_CASE = /^[A-Z]{1}[A-Z0-9]+(-[A-Z0-9]+)+$/;
